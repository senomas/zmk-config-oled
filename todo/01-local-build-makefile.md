...
- [x] Add container runtime auto-detection
...
- [x] Add CI-aligned codebase target
...
- [x] Add build.yaml-driven build target
  ...
  - ⚙️ [x] Replaced yq dependency entirely with Python inline heredoc. Root cause: yq was installed inside the hat container, not on the user's actual host machine. Python 3 is guaranteed available everywhere.
